...
<body>
    ...
    <div class="details">
        <p>Name of the Faculty&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $user->name ?? '____________________________' }}</p>
        <p>College/Department&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $department ?? '____________________________' }} / {{ Auth::user()->program ?? '____________________________' }}</p>
        <p>Date Submitted&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $lastClearanceUpdate ?? '____________________________' }}</p>
        <p>Checked by&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $user->checked_by ?? '____________________________' }}</p>
        <br>
        <br>
