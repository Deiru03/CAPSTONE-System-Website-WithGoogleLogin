<x-app-layout>
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="fileGrid">
            @foreach($archivedClearances->groupBy(['academic_year', 'semester']) as $year => $semesters)
                @foreach($semesters as $semester => $files)
                    <div class="bg-white rounded-xl border border-gray-200 hover:border-blue-400 hover:shadow-md transition-all duration-300">
    ...
    <div id="filesModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-40">
        <div class="bg-white rounded-xl w-11/12 max-w-3xl max-h-[90vh] flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto p-4" id="filesContainer">
    ...
    <div id="previewModal" class="fixed inset-0 bg-black bg-opacity-75 hidden items-center justify-center z-50">
        <div class="bg-white rounded-xl w-11/12 h-5/6 max-w-5xl flex flex-col">
            <div class="flex justify-between items-center p-4 border-b">
    ...
    <script>
        function openFilesModal(year, semester, files) {
            ...
            files.forEach(file => {
                ...
                fileElement.className = 'p-3 mb-3 rounded-lg hover:bg-gray-50 cursor-pointer border border-gray-100 hover:border-blue-200 transition-all duration-200';
                ...
                fileElement.innerHTML = `
                    <div class="flex items-center">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-700">${file.file_path.split('/').pop()}</p>
